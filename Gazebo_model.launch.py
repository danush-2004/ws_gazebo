...
from launch.actions import IncludeDescription
...
def generate_launch_description():
	...
	#this is the launch file from gazebo_ros package
    gazebo_rosPackageLaunch=PythonLaunchDescriptionSource(os.path.joint(get_package_share_directory("gazebo_ros"),"launch","gazebo.launch.py"))


    gazeboLaunch=IncludeLaunchDescription(gazebo_rosPackageLaunch,launch_argument={'world': pathWorldFile}.items())
